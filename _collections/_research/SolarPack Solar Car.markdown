...
<div class="row">
  ...
  <div class="col-md-6">
    ...
    <p> 
      <i class="fa fa-chevron-right"></i>As NC State's first solar vehicle team, SolarPack is aiming to show the world that solar energy can be used to power a multi-occupancy car that can run off the track.
    </p>
  </div>
</div>
<hr bordercolor = "lightgrey">
...
<div class="row">
  <div class="col-md-6">
    <br>
    <img src="https://github.com/zoelzw/zoelzw.github.io/blob/master/assets/solar2.png?raw=true" style='height: 100%; width: 100%; object-fit: contain'/>
  </div>
